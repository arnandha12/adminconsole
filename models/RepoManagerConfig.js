...
define([], function(){
	var repoMapping = {
		...
		LoginType  : {
			model : "AppConfigurationsObjService/LoginType/Model",
			config : "AppConfigurationsObjService/LoginType/MF_Config",
			repository : "AppConfigurationsObjService/LoginType/Repository",
		},
		leadnote  : {
		...
		alertfrequency  : {
			model : "AlertAndAlertTypes/alertfrequency/Model",
			config : "AlertAndAlertTypes/alertfrequency/MF_Config",
			repository : "AlertAndAlertTypes/alertfrequency/Repository",
		},
		eventsubtype  : {
		...
		alertrecipient  : {
			model : "AlertAndAlertTypes/alertrecipient/Model",
			config : "AlertAndAlertTypes/alertrecipient/MF_Config",
			repository : "AlertAndAlertTypes/alertrecipient/Repository",
		},
		CardRequests  : {
		...
		KeycloakUsers  : {
			model : "KeyCloakObjService/KeycloakUsers/Model",
			config : "KeyCloakObjService/KeycloakUsers/MF_Config",
			repository : "KeyCloakObjService/KeycloakUsers/Repository",
		},
		...
		bankFacility  : {
			model : "BankProductManagment/bankFacility/Model",
			config : "BankProductManagment/bankFacility/MF_Config",
			repository : "BankProductManagment/bankFacility/Repository",
		},
		bankProduct  : {
			model : "BankProductManagment/bankProduct/Model",
			config : "BankProductManagment/bankProduct/MF_Config",
			repository : "BankProductManagment/bankProduct/Repository",
		},
		LoanService  : {
			model : "CustomerLoanServiceObj/LoanService/Model",
			config : "CustomerLoanServiceObj/LoanService/MF_Config",
            repository : "",
		},
		ApprovalMatrix  : {
			model : "ApprovalMatrixManageObjService/ApprovalMatrix/Model",
			config : "ApprovalMatrixManageObjService/ApprovalMatrix/MF_Config",
			repository : "ApprovalMatrixManageObjService/ApprovalMatrix/Repository",
		},
		Customer  : {
		...
		InfinityUser  : {
			model : "CustomerManagementObjService/InfinityUser/Model",
			config : "CustomerManagementObjService/InfinityUser/MF_Config",
			repository : "CustomerManagementObjService/InfinityUser/Repository",
		},
		CustomerContact  : {
		...
		CustomerActions  : {
			model : "CustomerManagementObjService/CustomerActions/Model",
			config : "CustomerManagementObjService/CustomerActions/MF_Config",
			repository : "CustomerManagementObjService/CustomerActions/Repository",
		},
		ProductTransaction  : {
		...
		DueDiligence  : {
			model : "CustomerManagementObjService/DueDiligence/Model",
			config : "CustomerManagementObjService/DueDiligence/MF_Config",
			repository : "CustomerManagementObjService/DueDiligence/Repository",
		},
		alerthistory  : {
		...
		feature  : {
			model : "FeatureObjService/feature/Model",
			config : "FeatureObjService/feature/MF_Config",
			repository : "FeatureObjService/feature/Repository",
		},
		app  : {
		...
		SignatoryGroup  : {
			model : "SignatoryGroupManageObjService/SignatoryGroup/Model",
			config : "SignatoryGroupManageObjService/SignatoryGroup/MF_Config",
			repository : "SignatoryGroupManageObjService/SignatoryGroup/Repository",
		},
		ApprovalMode  : {
			model : "SignatoryGroupManageObjService/ApprovalMode/Model",
			config : "SignatoryGroupManageObjService/ApprovalMode/MF_Config",
			repository : "SignatoryGroupManageObjService/ApprovalMode/Repository",
		},
		...
		businessconfiguration  : {
			model : "BusinessConfigObjService/businessconfiguration/Model",
			config : "BusinessConfigObjService/businessconfiguration/MF_Config",
			repository : "BusinessConfigObjService/businessconfiguration/Repository",
		},
		AddressValidation  : {
		...
		media  : {
			model : "dbxdbObjects/media/Model",
			config : "dbxdbObjects/media/MF_Config",
			repository : "dbxdbObjects/media/Repository",
		},
		archivedmedia  : {
			model : "dbxdbObjects/archivedmedia/Model",
			config : "dbxdbObjects/archivedmedia/MF_Config",
			repository : "dbxdbObjects/archivedmedia/Repository",
		},
		customerLoanDetailServiceObject  : {
			model : "customerLoanDetailService/customerLoanDetailServiceObject/Model",
			config : "customerLoanDetailService/customerLoanDetailServiceObject/MF_Config",
			repository : "customerLoanDetailService/customerLoanDetailServiceObject/Repository",
		},
		country  : {
		...
		LOB  : {
			model : "InternalusersObjService/LOB/Model",
			config : "InternalusersObjService/LOB/MF_Config",
			repository : "InternalusersObjService/LOB/Repository",
		},
		DMSUser  : {
		...
		Contract  : {
			model : "ContractManagementObjService/Contract/Model",
			config : "ContractManagementObjService/Contract/MF_Config",
			repository : "ContractManagementObjService/Contract/Repository",
		},
		...
		servicedefinition  : {
			model : "BusinessBankingObjService/servicedefinition/Model",
			config : "BusinessBankingObjService/servicedefinition/MF_Config",
			repository : "BusinessBankingObjService/servicedefinition/Repository",
		},
		company  : {
		...
		businesstype  : {
			model : "BusinessBankingObjService/businesstype/Model",
			config : "BusinessBankingObjService/businesstype/MF_Config",
			repository : "BusinessBankingObjService/businesstype/Repository",
		},
		customer  : {
		...
		Config  : {
			model : "ConfigurationObjService/Config/Model",
			config : "ConfigurationObjService/Config/MF_Config",
			repository : "ConfigurationObjService/Config/Repository",
		},
		...
		DataSources  : {
			model : "CustomReports/DataSources/Model",
			config : "CustomReports/DataSources/MF_Config",
			repository : "CustomReports/DataSources/Repository",
		},
		ReportsList  : {
			model : "CustomReports/ReportsList/Model",
			config : "CustomReports/ReportsList/MF_Config",
			repository : "CustomReports/ReportsList/Repository",
		},
		ReportFilters  : {
			model : "CustomReports/ReportFilters/Model",
			config : "CustomReports/ReportFilters/MF_Config",
			repository : "CustomReports/ReportFilters/Repository",
		},
		Reports  : {
			model : "CustomReports/Reports/Model",
			config : "CustomReports/Reports/MF_Config",
			repository : "CustomReports/Reports/Repository",
		},
		FabricReports  : {
			model : "CustomReports/FabricReports/Model",
			config : "CustomReports/FabricReports/MF_Config",
			repository : "CustomReports/FabricReports/Repository",
		},
		channelandscreen  : {
		...
		profile  : {
			model : "CampaignManagementObjService/profile/Model",
			config : "CampaignManagementObjService/profile/MF_Config",
			repository : "CampaignManagementObjService/profile/Repository",
		},
		campaign  : {
		...
		attribute  : {
			model : "CampaignManagementObjService/attribute/Model",
			config : "CampaignManagementObjService/attribute/MF_Config",
			repository : "CampaignManagementObjService/attribute/Repository",
		},
		campaignmanagement  : {
			model : "CampaignManagementObjService/campaignmanagement/Model",
			config : "CampaignManagementObjService/campaignmanagement/MF_Config",
			repository : "CampaignManagementObjService/campaignmanagement/Repository",
		},
		group  : {
			model : "CampaignManagementObjService/group/Model",
			config : "CampaignManagementObjService/group/MF_Config",
			repository : "CampaignManagementObjService/group/Repository",
		},
		GroupEntitlements  : {
		...
		Groups  : {
			model : "CustomerGroupsAndEntitlObjSvc/Groups/Model",
			config : "CustomerGroupsAndEntitlObjSvc/Groups/MF_Config",
			repository : "CustomerGroupsAndEntitlObjSvc/Groups/Repository",
		},
		GroupFeatures  : {
			model : "CustomerGroupsAndEntitlObjSvc/GroupFeatures/Model",
			config : "CustomerGroupsAndEntitlObjSvc/GroupFeatures/MF_Config",
			repository : "CustomerGroupsAndEntitlObjSvc/GroupFeatures/Repository",
		},
		GroupCustomers  : {
		...
		report  : {
			model : "ReportsObjService/report/Model",
			config : "ReportsObjService/report/MF_Config",
			repository : "ReportsObjService/report/Repository",
		},
		TransactionReport  : {
		...
		Analytics  : {
			model : "DashboardObjService/Analytics/Model",
			config : "DashboardObjService/Analytics/MF_Config",
			repository : "DashboardObjService/Analytics/Repository",
		},
		dashboardalerts  : {
